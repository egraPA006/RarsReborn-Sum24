...
public class BGT implements PseudoInstruction {
    public ArrayList<ProgramStatement> template(ArrayList<Operand> args){
        ...
        ans.get(0).instruction = Globals.instructionMap.get("blt");
        ans.get(0).basicLine = "blt " + ((RegOperand)args.get(1)).getValue().getName() +
